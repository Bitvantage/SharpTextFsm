...
internal class LruCache<TKey, TValue> : ITemplateCache<TKey, TValue>
    where TKey : notnull
{
    private readonly int _cacheSize;
    private readonly LinkedList<TKey> _leastRecentlyUsed;
    private readonly Dictionary<TKey, Element> _valueCache;

    public LruCache(int cacheSize)
    {
        _cacheSize = cacheSize;
        _leastRecentlyUsed = new LinkedList<TKey>();
        _valueCache = new Dictionary<TKey, Element>(cacheSize);
    }
