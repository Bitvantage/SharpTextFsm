...
{
    internal class GenericTryParseConverterTest
    {
        [Test]
        public void Long()
        {
            var converter = new GenericTryParseConverter<long>();
        ...
        {
            var converter = new GenericTryParseConverter<IPAddress>();
        ...
        {
            var converter = new GenericTryParseConverter<TimeSpan>();
